...
page templates plus a templated blog engine generating 45 long-form
posts, 62 total indexed routes, full technical SEO (structured data,
...
**A typed content model instead of a CMS.** All 45 blog posts live as
...
- **17** hand-built page templates across 4 distinct page families, plus
  a blog engine generating **45** long-form posts, **62** total indexed
  routes
